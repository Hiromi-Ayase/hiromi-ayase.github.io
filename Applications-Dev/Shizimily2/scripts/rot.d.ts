declare module ROT {
    ...
    interface IScheduler {
        add(item: any, repeat: boolean): void;
        clear(): void;
        getTime(): void;
        next(): any;
...
declare module ROT.Scheduler {
    ...
    export class Simple implements IScheduler {
        constructor();
        add(item: any, repeat: boolean): void;
        clear(): void;
        getTime(): void;
    ...
    export class Speed extends Simple {
    }

    export class Action extends Simple  {
        setDulation(time: number): void;
    }
}
