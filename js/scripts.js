...
for (var i = 0; i < rawData.length; i ++) {
    ...
    list[i] = [d.id, d.madb_id, d.medium, start, d.broadcast, d.author, "<a href=\"" + d.madb_uri + "\">link</a>"];
}
$(document)
        .ready(
                function () {/* activate sidebar */
                    ...
                    new IncSearch.ViewTable(
                            ...
                            {
                                dispMax : 10, // オプション
                                startElementText : '<table class="table table-bordered"><tr><th>タイトル</th><th>Media Art DB ID</th><th>メディア</th><th>放送開始日</th><th>配信</th><th>作者</th><th>メディアDB</th>',
