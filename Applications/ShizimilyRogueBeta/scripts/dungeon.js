...
(function (ShizimilyRogue) {
    (function (Model) {
        ...
        var DungeonManager = (function () {
            ...
            DungeonManager.prototype.init = function (w, h, floor, player) {
                ...
                for (var i = 0; i < 5; i++) {
                    var enemy = new Model.Data.Word;
                    actions.unshift(this.addObject(enemy));
                }
                for (var i = 0; i < 3; i++) {
                    var item = Model.Data.ItemFactory.getItem();
            ...
            DungeonManager.prototype.hasNext = function () {
                return this.endState == 0 /* None */ && this.actionQueue.length > 0;
            };
        ...
        var FOVData = (function () {
            function FOVData(me, width, height, getCell, getCellByCoord, area, movable, objects, attackable, floor) {
                var _this = this;
                this.me = me;
                this.width = width;
                this.height = height;
        ...
        */
        var Unit = (function (_super) {
            ...
            Object.defineProperty(Unit.prototype, "atk", {
                get: function () {
                    return ShizimilyRogue.Common.Parameter.Atk + (this.weapon == null ? 0 : this.weapon.atk);
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(Unit.prototype, "def", {
                get: function () {
                    return ShizimilyRogue.Common.Parameter.Def + (this.guard == null ? 0 : this.guard.def);
                },
                enumerable: true,
                configurable: true
            });
        ...
        var Player = (function (_super) {
            ...
            Player.prototype.phase = function () {
                ...
                if (this.stomach == 0) {
                    this.hp -= 10;
                    if (this.hp <= 0)
                        return [ShizimilyRogue.Common.Action.Die()];
                } else {
        ...
        var Map = (function () {
            ...
            Map.prototype.getFOV = function (unit) {
                ...
                var result = new FOVData(unit, this.width, this.height, getCell, getCellByCoord, area, movable, objects, attackable, this.floor);
                return result;
            };
