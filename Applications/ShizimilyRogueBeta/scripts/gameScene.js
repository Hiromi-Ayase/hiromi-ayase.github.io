...
(function (ShizimilyRogue) {
    (function (_View) {
                ...
                while (true) {
                    ...
                    if (this.menuGroup.childNodes.length == 0) {
                        this.tl.delay(ShizimilyRogue.Common.Config.KEY_LOCK_RELEASE).then(function () {
                            return _View.Input.mode = 0 /* Game */;
                        });
                        break;
                    }
                }
        ...
        * ステータステキスト
        */
        var StatusLabel = (function (_super) {
            __extends(StatusLabel, _super);
            function StatusLabel(left, top) {
                _super.call(this);
                this.left = left;
                this.top = top;
            ...
            StatusLabel.prototype._show = function (s) {
                this.statusLable.text = s;
                this.statusLabelShadow.text = s;
            };

            Object.defineProperty(StatusLabel.prototype, "visible", {
                set: function (flg) {
            ...
            StatusLabel.SHADOW_LEFT = 2;
            StatusLabel.SHADOW_TOP = 2;
            return StatusLabel;
        })(enchant.Group);
        ...
        */
        var Clock = (function (_super) {
            ...
            function Clock() {
                _super.call(this, Clock.CLOCK_LEFT, Clock.CLOCK_TOP);
            }
            Clock.prototype.show = function (turn) {
                var second = turn % 60;
                var hour = (turn - second) / 60 + 17;
                _super.prototype._show.call(this, hour + " : " + (second < 10 ? "0" + String(second) : String(second)));
            };
            Clock.CLOCK_TOP = 10;
        ...
        */
        var Floor = (function (_super) {
            ...
            function Floor() {
                _super.call(this, Floor.FLOOR_LEFT, Floor.FLOOR_TOP);
            }
            Floor.prototype.show = function (floor) {
                var text = "" + floor;
                if (floor == 1) {
                    text += "st Floor";
                } else if (floor == 2) {
                ...
                _super.prototype._show.call(this, text);
            };
            Floor.FLOOR_TOP = 10;
            Floor.FLOOR_LEFT = 10;
            return Floor;
        ...
        var PlayerHp = (function (_super) {
            ...
            function PlayerHp() {
                _super.call(this, PlayerHp.PLAYERHP_LEFT, PlayerHp.PLAYERHP_TOP);
            }
            PlayerHp.prototype.show = function (hp, maxHp, stomach) {
                _super.prototype._show.call(this, hp + " / " + maxHp + " (" + stomach + ")");
            };
        ...
        */
        ...
        var View = (function (_super) {
            ...
            */
            ...
            // 視点移動
            View.prototype.moveCamera = function () {
                if (this.objects[ShizimilyRogue.Common.PLAYER_ID] != null) {
                    var x = this.objects[ShizimilyRogue.Common.PLAYER_ID].x;
                    var y = this.objects[ShizimilyRogue.Common.PLAYER_ID].y;
                    this.x = -x + (_View.VIEW_WIDTH - OBJECT_WIDTH) / 2;
                    this.y = -y + (_View.VIEW_HEIGHT - OBJECT_HEIGHT) / 2;
                }
            };
        ...
        var Menu = (function (_super) {
            ...
            */
            Menu.Item = function (data, selectHandler, multiple) {
                if (typeof multiple === "undefined") { multiple = false; }
                return new Menu(data, selectHandler, multiple, _View.Scene.ASSETS.MENU_WINDOW.DATA, 10, 10, 8, 5);
            };
            ...
            ViewObjectFactory.getPlayerInstance = function (obj) {
                ...
                var idleAnimation = function (sprite) {
                    if (obj.isNormal()) {
                        ...
                        if (obj.dir == 2 || obj.dir == 3 || obj.dir == 7) {
                            sprite.scaleX = -1;
                        } else {
                            sprite.scaleX = 1;
                        }
                ...
                var actionAnimation = function (sprite, action, speed) {
                    if (action.isAttack()) {
                        _View.Scene.ASSETS.SE_HEAL.DATA.clone().play();
                        sprite.tl.moveBy(ROT.DIRS[8][obj.dir][0] * 20, ROT.DIRS[8][obj.dir][1] * 20, 3).moveBy(ROT.DIRS[8][obj.dir][0] * -20, ROT.DIRS[8][obj.dir][1] * -20, 3).delay(5);
                        ...
                        if (obj.dir == 0 || obj.dir == 1 || obj.dir == 2 || obj.dir == 3) {
                            sprite.scaleX = -1;
                        } else {
                            sprite.scaleX = 1;
                        }
                        ...
                        sprite.tl.delay(5).then(function () {
                            sprite.frame = x[obj.dir][1];
                        }).delay(5);
                    } else if (action.isUse()) {
                        _View.Scene.ASSETS.SE_USE.DATA.clone().play();
                    } else if (action.isPick()) {
                        _View.Scene.ASSETS.SE_TAKE.DATA.clone().play();
                    } else if (action.isDie()) {
                        _View.Scene.ASSETS.SE_DIE.DATA.clone().play();
                    }
                };
                ...
                if (obj.category == 2) {
                    ...
                    var actionAnimation = function (sprite, action, speed) {
                        if (action.isAttack()) {
                            ...
                            _View.Scene.ASSETS.SE_ATTACK.DATA.clone().play();
                            sprite.frame = x[obj.dir][0];
                            sprite.tl.moveBy(ROT.DIRS[8][obj.dir][0] * 20, ROT.DIRS[8][obj.dir][1] * 20, 3).moveBy(ROT.DIRS[8][obj.dir][0] * -20, ROT.DIRS[8][obj.dir][1] * -20, 3).delay(5);
                        } else if (action.isStatus() && action.subType == 0 /* Damage */) {
                            var x = [
                    ...
                    return new ViewObject(obj, _View.Scene.ASSETS.WORD.DATA, idleAnimation, actionAnimation, -0.5, -1, 128, 96);
                } else {
