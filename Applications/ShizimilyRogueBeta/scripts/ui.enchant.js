 ...
 * @type {Object}
 */
enchant.ui = { assets: ['./images/ui/pad.png', './images/ui/apad.png', './images/ui/icon0.png', './images/ui/font0.png'] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    ...
    initialize: function() {
        ...
        var image = core.assets['./images/ui/pad.png'];
...
enchant.ui.APad = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(mode) {
        var core = enchant.Core.instance;
        var image = core.assets['./images/ui/apad.png'];
...
enchant.ui.Button = enchant.Class.create(enchant.Entity, {
    ...
    initialize: function(text, theme, height, width) {
        ...
        this.addEventListener("touchstart", function() {
            ...
            this.pressed = true;
            this.y++;
            core.changeButtonState(text.toLowerCase(), true);
        });
        ...
        this.addEventListener("touchend", function() {
            ...
            this.pressed = false;
            this.y--;
            core.changeButtonState(text.toLowerCase(), false);
        });
    },
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets['./images/ui/font0.png'],
...
enchant.ui.LifeLabel = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(x, y, maxlife) {
        ...
        for (var i = 0; i < this._maxlife; i++) {
            ...
            this.heart[i].image = enchant.Game.instance.assets['./images/ui/icon0.png'];
